...
class componente_form(ModelForm):
      ...
      def __init__(self,*args,**kwargs):
          ...
          super(componente_form, self).__init__(*args, **kwargs)
          self.fields['tipoc'].choices=rs3.all_for_select()
          self.fields['marcas'].choices=rs1.all_for_select()
          self.fields['proveedores'].choices=rs2.all_for_select()


      CO_ID=forms.IntegerField(widget = forms.HiddenInput(),required=False)
      CO_NOMBRE=forms.CharField(
      ...
      proveedores=forms.ChoiceField(
                              ...
                              required=True)
      class Meta:
          model=componente_model
          fields=('CO_ID','CO_NOMBRE','CO_PRECIO')